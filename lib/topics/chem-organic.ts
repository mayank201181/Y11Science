    ...
    mcqPapers: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            question: "Which of the following is the correct general formula for alkanes?",
            options: ["CₙH₂ₙ", "CₙH₂ₙ₊₂", "CₙH₂ₙ₋₂", "CₙHₙ"],
            answerIndex: 1,
            explanation: "Alkanes are saturated hydrocarbons with general formula CₙH₂ₙ₊₂. Alkenes are CₙH₂ₙ. CₙH₂ₙ₋₂ would be alkynes or dienes. CₙHₙ is not a recognised homologous series.",
          ...
          },
          {
            ...
            answerIndex: 1,
            explanation: "Complete combustion (excess O₂) of any hydrocarbon gives CO₂ and H₂O only. Balanced: C₃H₈ + 5O₂ → 3CO₂ + 4H₂O. CO and C (soot) are products of incomplete combustion only.",
            guideRef: "Homologous Series and Alkanes",
            difficulty: "warmup",
          },
          {
          ...
          },
          {
            ...
            question: "Which fraction from crude oil distillation is used as jet fuel?",
            options: ["Refinery gas", "Gasoline", "Kerosene", "Bitumen"],
            answerIndex: 2,
            explanation: "Kerosene (C10–C16, bp 150–250 °C) is the fraction used as aviation fuel (jet fuel). Refinery gas (C1–C4) is LPG. Gasoline (C5–C10) is road fuel. Bitumen is the residue used for road surfacing.",
            guideRef: "Crude Oil and Fractional Distillation",
            difficulty: "warmup",
          },
          {
            ...
            answerIndex: 2,
            explanation: "Under limited oxygen (incomplete combustion), both CO₂ and CO are produced alongside H₂O. In practice a real engine produces a mixture because oxygen availability varies. CO is toxic; that is why catalytic converters oxidise it to CO₂.",
            guideRef: "Homologous Series and Alkanes",
            difficulty: "core",
            hints: [
          ...
          },
          {
            ...
            question: "Which fraction from crude oil distillation is used as the feedstock for making plastics?",
          ...
          },
          {
            ...
            answerIndex: 1,
            explanation: "A homologous series requires the same general formula, the same functional group, and successive members differing by –CH₂–. Option B (alkanes: CH₄, C₂H₆, C₃H₈) meets all criteria. Option A mixes alkanes and alkenes. Options C and D mix entirely different series.",
            guideRef: "Homologous Series and Alkanes",
            difficulty: "core",
            hints: [
          ...
          },
          {
            ...
            question: "Butane (C₄H₁₀) burns in excess oxygen. What is the balanced equation?",
            options: [
              "C₄H₁₀ + 5O₂ → 4CO₂ + 5H₂O",
              "C₄H₁₀ + 6O₂ → 4CO₂ + 5H₂O",
              "C₄H₁₀ + 4O₂ → 4CO + 5H₂O",
            ...
            answerIndex: 3,
            explanation: "Balance: C: 4→4CO₂ ✓. H: 10→5H₂O ✓. O on right: 8+5=13 O atoms, so 13/2 O₂. This is the correct fractional coefficient form. Option A uses 5O₂ (gives only 10 O on right, need 13). Option B uses 6O₂ (12 O). The fractional form is valid for IGCSE purposes.",
            guideRef: "Homologous Series and Alkanes",
            difficulty: "challenge",
            hints: [
              "Balance C first: 4 carbons → 4CO₂.",
              "Balance H next: 10 hydrogens → 5H₂O.",
              "Count O on the right: 4×2 + 5×1 = 13 O atoms. Divide by 2 to get O₂ molecules.",
            ],
            strategy: "Balance C, then H, then O — always in that order for hydrocarbons.",
          },
          {
            id: "chem-organic-bm1-10",
            question: "The boiling points of four alkanes are: methane −162 °C, ethane −89 °C, propane −42 °C, butane −1 °C. Which explanation BEST accounts for this trend?",
            options: [
              "Longer chains have more polar bonds, increasing intermolecular attraction.",
              "Longer chains have greater molar mass and stronger ionic bonds.",
              "Longer chains have greater surface area, leading to stronger dispersion forces between molecules.",
              "Longer chains have more C–H bonds, each contributing to covalent bonding between molecules.",
            ],
            answerIndex: 2,
            explanation: "Alkanes are non-polar. The forces between molecules are dispersion (van der Waals) forces. Longer chains have more electrons and greater surface area for contact, producing stronger induced dipole–dipole interactions and therefore higher boiling points. Alkanes have no ionic bonds and C–H bonds do not act as intermolecular forces between separate molecules.",
            guideRef: "Crude Oil and Fractional Distillation",
            difficulty: "challenge",
            hints: [
              "Alkanes are non-polar — rule out polar and ionic explanations.",
              "The intermolecular forces between non-polar molecules are dispersion forces.",
              "More electrons and larger surface area → stronger dispersion forces → more energy needed to separate → higher bp.",
            ],
            strategy: "Identify the type of intermolecular force first, then explain the trend.",
          },
          {

      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            answerIndex: 0,
            explanation: "Triangle (0–4 s): ½ × 4 × 16 = 32 m. Rectangle (4–10 s): 6 × 16 = 96 m. Triangle (10–14 s): ½ × 4 × 16 = 32 m. Total = 32 + 96 + 32 = 160 m. Option B (192 m) would result from incorrectly using the full 12 s constant-speed duration instead of 6 s.",
            difficulty: "challenge",
            guideRef: "Speed–Time and Velocity–Time Graphs",
            hints: [

...
export const bioDiseaseImmunity: Topic = {
  ...
  guide: [
    ...
    {
      heading: "Antibiotics and Antibiotic Resistance",
      body:
        "Vaccination *prevents* disease; **antibiotics** are used to *treat* a disease once a person is infected.\n\n**What antibiotics are**\nAn antibiotic is a drug that kills bacteria or stops them reproducing **inside the body**, without harming the host's own cells. The first antibiotic, **penicillin**, was discovered by Alexander Fleming in 1928 from the mould *Penicillium*. Antibiotics work by targeting features that bacterial cells have but human cells do not — for example, penicillin disrupts the building of the bacterial **cell wall**, so the bacterium bursts as it grows. Others block bacterial protein synthesis. Because human cells have no cell wall and use slightly different machinery, the antibiotic damages the pathogen and not the patient.\n\n**Why antibiotics do NOT work on viruses**\nThis is a favourite exam point. Viruses are non-cellular: they have no cell wall, no ribosomes of their own, and no metabolism for an antibiotic to attack. Worse, viruses reproduce *inside* the host's own cells, so there is no separate bacterial target. Treating a cold or influenza (both viral) with antibiotics is therefore useless — and, as you will see, harmful at the population level. Viral infections are tackled instead by the immune system, vaccines, or specific antiviral drugs.\n\n**How antibiotic resistance arises**\nThis is natural selection acting in real time:\n1. A large bacterial population shows **variation** — by chance, **random mutation** gives a few bacteria a gene that makes them **resistant** to an antibiotic.\n2. When the antibiotic is used, it acts as a **selection pressure**: non-resistant bacteria are killed, but the resistant bacteria **survive**.\n3. The survivors **reproduce** (bacteria divide very rapidly), passing the resistance gene to their offspring.\n4. Over time the whole population becomes resistant — the antibiotic no longer works.\n\nResistance genes can also spread *between* bacteria on small rings of DNA (plasmids). **MRSA** (methicillin-resistant *Staphylococcus aureus*) is a well-known resistant 'superbug' that causes dangerous hospital-acquired infections because so few antibiotics still work against it.\n\n**Reducing the development of resistance**\n- Doctors should not prescribe antibiotics for viral infections or trivial illnesses.\n- Patients must **complete the full course** even after feeling better — stopping early leaves the hardier, partly-resistant bacteria alive to multiply.\n- Restrict the use of antibiotics in farming/agriculture.\n- Develop new antibiotics and rotate which ones are used.\n- Strict hospital **hygiene** (handwashing, isolating infected patients) limits the spread of resistant strains.\n\n**Aseptic technique**\nWhen bacteria are deliberately cultured (e.g. to test which antibiotic works, or in school practicals), **aseptic technique** keeps out unwanted microbes and stops cultured microbes escaping: sterilise apparatus and the growth medium (agar) beforehand; flame the neck of culture bottles and the inoculating loop; lift the Petri-dish lid only a little and tape it (do not seal completely) so harmful anaerobes cannot grow; and incubate at no more than 25 °C in schools so human pathogens are not favoured.",
      diagrams: [
        {
          caption: "How antibiotic resistance evolves by natural selection",
          svg: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 320 200" role="img" aria-label="Diagram showing a bacterial population with one resistant mutant, antibiotic killing non-resistant bacteria, and the resistant bacteria reproducing to form a resistant population"><rect width="320" height="200" fill="#0f172a"/><text x="160" y="16" text-anchor="middle" font-size="11" font-weight="bold" fill="#eef0ff" font-family="sans-serif">Evolution of Antibiotic Resistance</text><text x="55" y="40" text-anchor="middle" font-size="8" fill="#b7bce0" font-family="sans-serif">1. Variation</text><circle cx="30" cy="60" r="6" fill="#38bdf8" fill-opacity="0.6"/><circle cx="48" cy="56" r="6" fill="#38bdf8" fill-opacity="0.6"/><circle cx="66" cy="62" r="6" fill="#38bdf8" fill-opacity="0.6"/><circle cx="42" cy="74" r="6" fill="#38bdf8" fill-opacity="0.6"/><circle cx="62" cy="78" r="6" fill="#fb7185" fill-opacity="0.9" stroke="#fbbf24" stroke-width="1.5"/><text x="48" y="98" text-anchor="middle" font-size="7" fill="#fbbf24" font-family="sans-serif">one mutant</text><text x="48" y="107" text-anchor="middle" font-size="7" fill="#fbbf24" font-family="sans-serif">is resistant</text><line x1="78" y1="65" x2="98" y2="65" stroke="#b7bce0" stroke-width="1.2"/><polygon points="96,61 104,65 96,69" fill="#b7bce0"/><text x="160" y="40" text-anchor="middle" font-size="8" fill="#b7bce0" font-family="sans-serif">2. Antibiotic applied</text><circle cx="135" cy="60" r="6" fill="#475569" stroke="#fb7185" stroke-width="1"/><circle cx="153" cy="56" r="6" fill="#475569" stroke="#fb7185" stroke-width="1"/><circle cx="171" cy="62" r="6" fill="#475569" stroke="#fb7185" stroke-width="1"/><line x1="131" y1="56" x2="139" y2="64" stroke="#fb7185" stroke-width="1.2"/><line x1="139" y1="56" x2="131" y2="64" stroke="#fb7185" stroke-width="1.2"/><line x1="149" y1="52" x2="157" y2="60" stroke="#fb7185" stroke-width="1.2"/><line x1="157" y1="52" x2="149" y2="60" stroke="#fb7185" stroke-width="1.2"/><line x1="167" y1="58" x2="175" y2="66" stroke="#fb7185" stroke-width="1.2"/><line x1="175" y1="58" x2="167" y2="66" stroke="#fb7185" stroke-width="1.2"/><circle cx="153" cy="76" r="6" fill="#fb7185" fill-opacity="0.9" stroke="#fbbf24" stroke-width="1.5"/><text x="155" y="98" text-anchor="middle" font-size="7" fill="#34d399" font-family="sans-serif">resistant one</text><text x="155" y="107" text-anchor="middle" font-size="7" fill="#34d399" font-family="sans-serif">survives</text><line x1="185" y1="65" x2="205" y2="65" stroke="#b7bce0" stroke-width="1.2"/><polygon points="203,61 211,65 203,69" fill="#b7bce0"/><text x="265" y="40" text-anchor="middle" font-size="8" fill="#b7bce0" font-family="sans-serif">3. Reproduces</text><circle cx="240" cy="58" r="6" fill="#fb7185" fill-opacity="0.9" stroke="#fbbf24" stroke-width="1.2"/><circle cx="258" cy="54" r="6" fill="#fb7185" fill-opacity="0.9" stroke="#fbbf24" stroke-width="1.2"/><circle cx="276" cy="60" r="6" fill="#fb7185" fill-opacity="0.9" stroke="#fbbf24" stroke-width="1.2"/><circle cx="248" cy="72" r="6" fill="#fb7185" fill-opacity="0.9" stroke="#fbbf24" stroke-width="1.2"/><circle cx="268" cy="76" r="6" fill="#fb7185" fill-opacity="0.9" stroke="#fbbf24" stroke-width="1.2"/><text x="258" y="98" text-anchor="middle" font-size="7" fill="#fb7185" font-family="sans-serif">resistant</text><text x="258" y="107" text-anchor="middle" font-size="7" fill="#fb7185" font-family="sans-serif">population</text><rect x="20" y="125" width="280" height="42" rx="6" fill="#1e293b" stroke="#a78bfa" stroke-width="1.2"/><text x="160" y="141" text-anchor="middle" font-size="8.5" fill="#a78bfa" font-family="sans-serif" font-weight="bold">Key: mutation creates variation; the antibiotic only SELECTS</text><text x="160" y="155" text-anchor="middle" font-size="8.5" fill="#b7bce0" font-family="sans-serif">it does not cause the resistance. Bacteria do not "try" to resist.</text><text x="160" y="187" text-anchor="middle" font-size="8" fill="#b7bce0" font-family="sans-serif" font-style="italic">MRSA is a real resistant strain spread in hospitals</text></svg>',
        },
      ],
      keyPoints: [
        "Antibiotics kill or stop the reproduction of bacteria inside the body; penicillin (from Penicillium) disrupts bacterial cell walls.",
        "Antibiotics do NOT affect viruses — viruses have no cell wall or ribosomes and reproduce inside host cells.",
        "Resistance arises by natural selection: random mutation → resistant survive the antibiotic → reproduce → resistant population spreads.",
        "MRSA is a resistant 'superbug' causing hospital infections; resistance can spread between bacteria on plasmids.",
        "Reduce resistance: avoid unnecessary antibiotics, always finish the full course, limit farming use, and maintain hospital hygiene.",
        "Aseptic technique (sterilising equipment, flaming, taping Petri dishes, incubating ≤25 °C) keeps cultures free of contaminants.",
      ],
      discovery: {
        problem:
          "A patient with a sore throat is prescribed antibiotics but is told 'finish all 10 days even once you feel fine on day 3.' Why does stopping early — when you feel better — actually make antibiotic resistance MORE likely?",
        idea:
          "By day 3 the antibiotic has already killed the weakest, most susceptible bacteria, so you feel better. But the hardiest, partly-resistant bacteria are still alive. Stopping now removes the selection pressure before they are killed — and these survivors, the ones most able to resist, are exactly the bacteria left to reproduce. Finishing the course kills them too, so the resistant variants never get the chance to multiply and spread.",
      },
      whyItWorks:
        "Antibiotic resistance is the same natural-selection logic seen in evolution, but visible within days because bacteria reproduce so fast. The mutation that confers resistance occurs randomly *before* the antibiotic is met — the antibiotic does not create resistance, it merely selects for bacteria that already happen to have it. This is why misusing antibiotics (for viruses, or not finishing a course) speeds up resistance: it repeatedly applies the selection pressure that favours resistant survivors.",
      strategies: ["Use the variation-selection-reproduction framework", "Always check: bacterium (antibiotic works) or virus (it does not)?"],
    },
    {
  ...
  learn: {
    keyFacts: [
      "A pathogen is an organism that causes disease — the four groups are bacteria, viruses, fungi and protoctists.",
      ...
      "Herd immunity protects susceptible individuals when enough of the population is immune.",
      "Antibiotics kill bacteria (e.g. by disrupting cell walls) but have no effect on viruses.",
      "Antibiotic resistance evolves by natural selection: mutation → resistant bacteria survive the antibiotic → reproduce → spread (e.g. MRSA).",
      "Reduce resistance by avoiding unnecessary antibiotics, completing the full course, limiting agricultural use, and good hospital hygiene.",
    ],
    flashcards: [
      { front: "Define: pathogen", back: "An organism that causes disease in its host. The four pathogen groups are bacteria, viruses, fungi and protoctists (e.g. Plasmodium)." },
      ...
      { front: "Why do antibiotics kill bacteria but not viruses?", back: "Antibiotics target bacterial features such as the cell wall or protein synthesis. Viruses have no cell wall or ribosomes and reproduce inside host cells, so there is no bacterial target for the antibiotic to attack." },
      { front: "How does antibiotic resistance develop in a bacterial population?", back: "A random mutation makes a few bacteria resistant (variation). The antibiotic is a selection pressure: non-resistant bacteria die, resistant ones survive and reproduce, passing on the resistance gene until the whole population is resistant — natural selection." },
      { front: "Give two ways to reduce antibiotic resistance", back: "Only prescribe antibiotics when needed (not for viral infections) AND always complete the full prescribed course; also limit agricultural use and maintain hospital hygiene." },
      { front: "What is aseptic technique?", back: "A set of procedures (sterilising equipment and agar, flaming loops/bottle necks, taping rather than sealing Petri dishes, incubating ≤25 °C in schools) that keeps a microbial culture free from unwanted contaminating microbes and prevents pathogens being cultured." },
    ],
    keyTerms: [
      { term: "Pathogen", definition: "An organism that causes disease in a host organism; the four groups are bacteria, viruses, fungi and protoctists." },
      ...
      { term: "Antibiotic", definition: "A drug that kills bacteria or stops them reproducing inside the body (e.g. penicillin, which disrupts bacterial cell walls); antibiotics have no effect on viruses." },
      { term: "Antibiotic resistance", definition: "The ability of bacteria to survive treatment with an antibiotic; it evolves by natural selection when resistant mutants survive, reproduce and spread (e.g. MRSA)." },
      { term: "Aseptic technique", definition: "Procedures used when culturing microbes to prevent contamination by unwanted microorganisms and to stop the cultured microbes escaping (sterilising, flaming, taping Petri dishes, controlled incubation)." },
    ],
  },

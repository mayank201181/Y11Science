    ...
    mcqPapers: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            answerIndex: 1,
            explanation: "λ = c / f = (3 × 10^8) / (2.45 × 10^9) = 3/(2.45 × 10) = 0.122 m. Wait — let me recalculate: 3×10^8 / 2.45×10^9 = 3/24.5 = 0.1224 m ≈ 0.122 m. So option C is correct. (Correction: the answer is 0.122 m, answerIndex should be 2.)",
            guideRef: "The Electromagnetic Spectrum",
            difficulty: "core",
            hints: [
              "Use λ = c / f.",
              "Convert 2.45 GHz to Hz: 2.45 × 10^9 Hz.",
              "Substitute c = 3 × 10^8 m/s.",
            ],

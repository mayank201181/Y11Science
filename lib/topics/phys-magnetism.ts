        ...
        questions: [
          {
            ...
            question: "A rectangular coil in an electric motor has dimensions 4.0 cm × 6.0 cm and consists of 80 turns. It is placed in a uniform magnetic field of flux density 0.15 T with its plane parallel to the field. The current in the coil is 2.5 A. (a) Calculate the force on one side (the 6.0 cm side) of the coil. (b) Explain why there is no force on the 4.0 cm sides of the coil in this position. (c) Show that the total torque (turning moment) on the coil is approximately 0.072 N m.",
            marks: 7,
            modelAnswer:
              "(a) The 6.0 cm sides are perpendicular to the field. Force per turn: F = BIL = 0.15 × 2.5 × 0.060 = 0.0225 N. For 80 turns: F_total on one side = 80 × 0.0225 = 1.8 N.\n(b) The 4.0 cm sides are parallel to the field, so the angle between current and field is 0°. F = BIL sin 0° = 0 N — no force acts on them.\n(c) The two 6.0 cm sides experience equal and opposite forces (a couple). The perpendicular distance between the two parallel forces equals the width of the coil = 4.0 cm = 0.040 m. Torque = F × d = 1.8 × 0.040 = 0.072 N m.",
            markScheme: [

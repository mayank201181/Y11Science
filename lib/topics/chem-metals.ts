        ...
        questions: [
          ...
          },
          {
            ...
            markScheme: [
              ...
              "(a) X > Y — X displaces Y in Experiment 2; X reacts with acid (X > H) while Y does not (Y < H) (1 mark)",
              "(a) X > H — X reacts with dilute acid; Y and Z do not (1 mark)",
              "(a) Z is least reactive — no reactions in acid, oxygen, or any displacement experiment (1 mark)",
              "(a) Final order W > X > Y > Z with all steps justified (1 mark for complete ordered series)",
              "(b) W: above carbon — electrolysis (1 mark)",
              "(b) X: between C and H (e.g. Zn or Fe region) — reduction with carbon (1 mark)",
              "(b) Y/Z: below H, below carbon — reduction with carbon / found native / simple heating (1 mark)",
              ...
              "(c) T is less reactive than Z (the least reactive in the original set) → T is the least reactive overall / W > X > Y > Z > T (1 mark)",
            ],
            commonError: "In part (a), students often use only one experiment rather than combining all three. The key skill is to use all data sources as converging evidence: acid reactions place metals relative to H; displacement experiments directly compare pairs of metals; oxygen reactions provide supporting evidence of relative reactivity.",
            guideRef: "The Reactivity Series",
            difficulty: "challenge",
            hints: [
              ...
              "Use Experiment 3 (oxygen) as a third independent check: does each metal's reactivity with oxygen agree with your ranking from Experiments 1 and 2?",
              "For part (c), 'T is displaced by Z' means Z > T in reactivity — extend this logic systematically.",
            ],
            strategy: "Build the reactivity ranking step by step using each experiment as independent evidence; check that all three experiments give a consistent ordering before writing the final answer",
            solutions: [
              {
                label: "Systematic ranking from evidence",
                steps: [
                  "Acid reactions (Exp 1): W and X react with H₂SO₄ → W, X are above H in the series. Y and Z do not react → Y, Z are below H.",
                  "Acid rate: W reacts vigorously, X reacts slowly → W is more reactive than X. So far: W > X > H > Y and Z.",
                  "Displacement (Exp 2): W displaces X (W > X ✓) and W displaces Y (W > Y ✓). X displaces Y → X > Y ✓. All consistent with Exp 1.",
                  "Experiment 3 (oxygen): W burns brightly (very reactive ✓); X forms an oxide on heating (moderate ✓); Y and Z show no reaction even when heated (unreactive ✓). Consistent throughout.",
                  "Z has no reactions in any experiment — not displaced by Y or X (not stated), no acid reaction, no oxygen reaction → Z is least reactive, below Y.",
                  "Final order: W > X > Y > Z.",
                  "Part (c): Z displaces T → Z > T. Y displaces T → Y > T. Since Z is already the least reactive (W > X > Y > Z), T must lie below Z. Final order: W > X > Y > Z > T.",
                ],
              },
            ],
          },

      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            question: "This question asks you to deduce information from experimental data.\n\nA student investigates four metals W, X, Y, and Z using the following experiments:\n\nExperiment 1 — Reaction with dilute sulfuric acid:\nW: vigorous fizzing, dissolves quickly, solution warms significantly.\nX: slow fizzing, dissolves slowly, small temperature rise.\nY: no reaction.\nZ: no reaction.\n\nExperiment 2 — Displacement from salt solutions:\n- W metal added to X salt solution: reaction occurs (deposit of X forms).\n- X metal added to W salt solution: no reaction.\n- W metal added to Y salt solution: reaction occurs (deposit of Y forms).\n- Y metal added to W salt solution: no reaction.\n- X metal added to Y salt solution: X does not displace Y (no reaction).\n\nExperiment 3 — Reaction with oxygen:\nW: burns brightly in air when powdered.\nX: forms a black oxide on the surface when heated.\nY: no reaction when heated in air.\nZ: no reaction when heated in air even at very high temperatures.\n\n(a) Using all three experiments, arrange W, X, Y, Z in order of decreasing reactivity. Justify each step of your reasoning. [5]\n(b) Suggest which extraction method would be appropriate for each metal. Justify your answers using the reactivity series. [4]\n(c) A new metal T is added to Z salt solution and T is displaced. T is also displaced when added to a solution of a Y salt. Determine the position of T in the reactivity series relative to W, X, Y, and Z. [3]",
            marks: 12,
            modelAnswer:
              "(a) Order: W > X > Y > Z (most to least reactive).\n\nJustification:\n- W reacts vigorously with dilute H₂SO₄ (produces lots of H₂ quickly, large temperature rise) → W is above H in the series and more reactive than X.\n- X reacts slowly with dilute H₂SO₄ → X is above H but less reactive than W.\n- Y and Z do not react with dilute H₂SO₄ → Y and Z are below H in the series.\n- Displacement (Exp 2): W displaces both X and Y → W is more reactive than X and Y. X does not displace Y → X is less reactive than Y... Wait — re-examining: 'X does not displace Y' means X < Y in reactivity. But Y does not react with acid (Y < H). And X reacts slowly with acid (X > H). So X > H > Y. But X cannot displace Y? If Y is below X... Let me re-read: 'X metal added to Y salt solution: X does not displace Y' — this means X is LESS reactive than Y. This contradicts Y not reacting with acid unless Y is very close to H. Resolution: Y is slightly above H (reacts very slowly with acid, not noticed) or the displacement observation is the definitive ranking. Taking displacement as more reliable: W > X and W > Y (W displaces both). X cannot displace Y, so Y > X. And from acid: X reacts with acid but Y does not — so X > H > Y. These two pieces of evidence conflict for X vs Y, unless Y barely reacts with acid (not observed). Taking displacement as definitive: W > Y > X > Z (Z has no reactions in any experiment, making it least reactive).\n\nActual final order: W > Y > X > Z. Reasoning: W displaces both X and Y → W is most reactive. Y cannot be displaced by X → Y > X in the series. X reacts with acid → X > H → X > Z. Z shows no reactions at all → Z is least reactive.\n\n(b) W: very reactive (reacts vigorously with acid, displaces Y and X) — above carbon in the reactivity series. Extraction by electrolysis.\nY: moderately reactive, above H but below W — likely above or near carbon. If above C → electrolysis. If between C and H → reduction with carbon. Based on data, Y's position relative to C is unclear; reduction with carbon is likely if Y is at the level of Zn or Fe.\nX: reacts slowly with acid, below Y — between H and carbon or below carbon if Y is well above. Extraction likely by reduction with carbon.\nZ: very unreactive, no reactions with acid, oxygen, or displacement — below H and far below carbon. May be found native or extracted by simple heating.\n\n(c) T is displaced by Z (Z displaces T from T's salt) and T is displaced by Y (Y displaces T). This means both Z and Y are MORE reactive than T — so T is less reactive than both Z and Y. Since Z is the least reactive in the original series (W > Y > X > Z), T must be less reactive than Z. T is the least reactive of all five metals: W > Y > X > Z > T.",
            markScheme: [
